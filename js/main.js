...
// const menuMainEls = document.querySelectorAll('header ul#menu__main>li a')
// const menuSubEl = document.querySelector('header #menu__sub')
// const menuSubTxtEl = document.querySelector('header #menu__sub .inner #sub-content')

// menuMainEls.forEach(menuMainEl => {
//   menuMainEl.addEventListener("mouseover", showMenu)
  
//   menuMainEl.addEventListener("mouseout", hideMenu)
// });

// menuSubEl.addEventListener("mouseover", showMenu)
// menuSubEl.addEventListener("mouseout", hideMenu)

// function showMenu() {
//   menuSubEl.style.display = "block";
//   setTimeout(function() {
//     menuSubEl.style.height = "200px";
//   }, 100)
//   setTimeout(function() {
//     menuSubTxtEl.style.display = "flex";
//   }, 200)
//   setTimeout(function() {
//     menuSubTxtEl.style.opacity = "1";
//   }, 300)
// }

// function hideMenu() {
//   menuSubEl.style.height = "0px";
//   menuSubTxtEl.style.opacity = "0";
//   menuSubTxtEl.style.display = "none";
//   menuSubEl.style.display = "none";
// }